...
$ git clone https://github.com/SureshKamediya/distributed-order-processing-platform.git
$ cd distributed-order-processing-platform/bookstore-backend-services
```
