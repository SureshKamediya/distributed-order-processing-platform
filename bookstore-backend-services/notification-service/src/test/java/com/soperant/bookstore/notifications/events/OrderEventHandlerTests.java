package com.soperant.bookstore.notifications.events;
...
import com.soperant.bookstore.notifications.AbstractIT;
import com.soperant.bookstore.notifications.ApplicationProperties;
import com.soperant.bookstore.notifications.domain.models.Address;
import com.soperant.bookstore.notifications.domain.models.Customer;
import com.soperant.bookstore.notifications.domain.models.OrderCancelledEvent;
import com.soperant.bookstore.notifications.domain.models.OrderCreatedEvent;
import com.soperant.bookstore.notifications.domain.models.OrderDeliveredEvent;
import com.soperant.bookstore.notifications.domain.models.OrderErrorEvent;
...
class OrderEventHandlerTests extends AbstractIT {
    ...
    Customer customer = new Customer("Suresh", "suresh@gmail.com", "999999999");
